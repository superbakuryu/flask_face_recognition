...
krish_image = face_recognition.load_image_file(os.path.join(basedir,'static',"Krish","krish.jpg"))
krish_face_encoding = face_recognition.face_encodings(krish_image)[0]

# Load a second sample picture and learn how to recognize it.
bradley_image = face_recognition.load_image_file(os.path.join(basedir,'static',"Bradley","bradley.jpg"))
...
thuan_image = face_recognition.load_image_file(os.path.join(basedir,'static',"Thuan","Thuan.jpg"))
